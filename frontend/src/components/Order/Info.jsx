  ...
  if (loading) {
    return (
      <div id="order-info">
        <img
          src={load}
          style={{ width: "500px", paddingTop: "15%", paddingLeft: "15%" }}
          alt=""
        />
      </div>
    );
      ...
      <div id="order-info">
        ...
        <div id="counts">
          ...
          <InfoDisplay
            label="Contact phone"
            value={user?.phone}
            loading={user?.phone === undefined}
          />
          <InfoDisplay
            label="Ship from"
            value={order?.rest_name}
            loading={order?.rest_name === undefined}
          />
        ...
        <div id="payment">
          ...
          <div id="payment-method">
            ...
            <button
              onClick={() => setPaymentMode("Card to courier")}
            ...
            >
              <p
                className="error"
                style={
                  cardRequired ? { display: "block" } : { display: "none" }
                }
              >
              ...
              />
              <p id="add-payment" onClick={() => setAddPayment(true)}>
                Add payment card
              </p>
            </div>
          </div>
        ...
        <div id="btns">
          ...
          <button id="order" onClick={(e) => updateOrder(e)}>
            Order
          </button>
        </div>
    ...
    return (
      <div id="order-info">
        <div id="new-payment">
          ...
          <p
            id="invalid-card"
            style={invalidInfo ? { display: "block" } : { display: "none" }}
          >
            Invalid card info
          </p>
          <p
            id="invalid-card"
            style={
              paymentAlreadyExists ? { display: "block" } : { display: "none" }
            }
          >
            Card already exists
          </p>
          <div className="btns">
            <button id="cancel" onClick={() => setAddPayment(false)}>
              Cancel
            </button>
            <button
              id="add-payment"
